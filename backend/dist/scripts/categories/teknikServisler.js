...
exports.teknikServisler = void 0;
const brands_1 = require("./brands");
exports.teknikServisler = {
    ...
    subcategories: [
        ...
        },
        {
            ...
            subcategories: brands_1.MOTOR_BRANDS.map(brand => ({ name: `${brand} Servisi`, description: `${brand} yetkili servisi` }))
        },
    ]
};
