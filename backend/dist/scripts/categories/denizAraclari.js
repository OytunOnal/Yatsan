...
exports.denizAraclari = void 0;
const brands_1 = require("./brands");
exports.denizAraclari = {
    name: 'Deniz Araçları',
    icon: '🚤',
            ...
            subcategories: [
                {
                    ...
                    subcategories: brands_1.BOAT_BRANDS.map(brand => ({ name: brand, description: `${brand} motoryat` }))
                },
                {
                    name: 'Yelkenli',
                    description: 'Yelkenli tekneler',
                    subcategories: brands_1.BOAT_BRANDS.slice(0, 15).map(brand => ({ name: brand, description: `${brand} yelkenli` }))
                },
                {
                    name: 'Katamaran',
            ...
            subcategories: [
                {
                    name: 'Motoryat',
                    description: 'Motor yatlar',
                    subcategories: brands_1.BOAT_BRANDS.slice(0, 20).map(brand => ({ name: brand, description: `${brand} motoryat` }))
                },
                {
                    name: 'Yelkenli',
                    description: 'Yelkenli tekneler',
