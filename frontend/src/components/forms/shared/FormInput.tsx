...
export interface FormInputProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'ref'> {
  label?: string;
  error?: string;
...
export const FormInput = forwardRef<HTMLInputElement, FormInputProps>(
  ({ label, error, className = '', containerClassName = '', id, name, required = false, ...props }, ref) => {
