...
export default function Footer() {
  ...
  const categories = [
    { name: 'Yatlar', href: '/listings?category=YACHT', icon: '⛵' },
    { name: 'Yedek Parça', href: '/listings?category=PART', icon: '🔧' },
    { name: 'Marina', href: '/listings?category=MARINA', icon: '⚓' },
    { name: 'Mürettebat', href: '/listings?category=CREW', icon: '👤' },
  ];
  ...
  const supportLinks = [
    ...
    { name: 'İlan Verme Rehberi', href: '/guide' },
    { name: 'Güvenli Alışveriş', href: '/safety' },
    { name: 'SSS', href: '/faq' },
  ];
